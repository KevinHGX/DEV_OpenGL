...
#INC_SDL = 	-I$(CONAN_INCLUDE_DIRS_SDL_IMAGE)/SDL2 \
			-I$(CONAN_INCLUDE_DIRS_SDL)/SDL2

#INC_L = -L$(CONAN_LIB_DIRS_SDL_IMAGE__SDL_IMAGE) -L$(CONAN_LIB_DIRS_SDL_LIBSDL2) 

#LIBS = $(INC_L) \
       -l$(CONAN_LIBS_SDL_IMAGE__SDL_IMAGE) \
       -l$(CONAN_LIBS_SDL_LIBSDL2) \
       -l$(CONAN_LIBS_SDL_SDL2MAIN)
...
.PHONY: build   
build: Version sub_make_ImGui sub-make-SDL
